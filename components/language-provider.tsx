...
const FR = {
  ...
  home_title: "Le Grand Marché de Lomé version numérique.",
  home_subtitle: "Une sélection rigoureuse d'articles entre particuliers. Sécurisé, rapide et pensé pour durer.",
  home_cta_explore: "Explorer",
  home_cta_sell: "Vendre un article",
